...
def to_predict(font):
    ...
    command = f"python {current_path}/practice/test.py --eval_data {current_path}/data/ --workers 0 --batch_size 128 --saved_model {current_path}/practice/models/"+font_select[font]+".pth --batch_max_length 25 --imgH 64 --imgW 200 --data_filtering_off --Transformation TPS --FeatureExtraction ResNet --SequenceModeling BiLSTM --Prediction Attn"
